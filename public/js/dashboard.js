...
async function initializeDashboard() {
    ...
    try {
        ...
        if (appsContainer) {
            ...
            const gsoLinkHTML = `
                <a href="${GSO_PROD_URL}" class="dynamic-link flex items-start space-x-4 rounded-lg bg-white p-6 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
            ...
            const gsoDevLinkHTML = `
                <a href="${GSO_DEV_URL}" class="dynamic-link flex items-start space-x-4 rounded-lg bg-white p-6 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
